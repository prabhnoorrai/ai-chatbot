...
export default function Home() {
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Hello! I'm the AI CS Mentor. How may I assist you today?",
    },
  ]);
  ...
  return (
    <Box
      ...
      alignItems="center"
      sx={{
        backgroundImage: `url('https://wallpapers.com/images/hd/coding-background-zmygixkpkncbe0hs.jpg')`,
      ...
      >
        ...
        >
          ...
          <p style={{ color: colors.text }}>
            Welcome to the AI CS Mentor support service. How can I assist you
            along your coding journey today?
          </p>
        </Box>
        <Stack
          direction="column"
